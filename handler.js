...
import fixdelay from './putra/fixdelay.js'
import {
WelcomeLeave
} from "./lib/welcome.js"
/**
...
for (let name in global.plugins) {
	...
	if ((usedPrefix = (match[0] || "")[0])) {
		...
		if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
			this.sendMessage(m.chat, {
text: '```🚩 ᴍᴀᴀғ ʟɪᴍɪᴛᴍᴜ sᴜᴅᴀʜ ʜᴀʙɪs sɪʟᴀʜᴋᴀɴ ʙᴇʟɪ ᴘʀᴇᴍɪᴜᴍ / ᴍɪɴᴛᴀ ғʀᴇᴇ ʟɪᴍɪᴛ ᴋᴇ ᴏᴡɴᴇʀ:\nwa.me/6283846016963?text=bang%20gif%20limit%20bang:v```\n\nʙɪꜱᴀ ᴊᴜɢᴀ ᴄʟᴀɪᴍ ʟɪᴍɪᴛ ʜᴀʀɪᴀɴ ᴀɴᴅᴀ ᴅᴇɴɢᴀɴ ᴄᴀʀᴀ ᴋᴇᴛɪᴋ .ᴄʟᴀɪᴍʟɪᴍɪᴛ',
contextInfo: {
externalAdReply: { showAdAttribution: true, 
title: `Sorry, your limit has run out!!`,
body: '2023 - 2025 © ZalxZhu',
thumbnailUrl: 'https://telegra.ph/file/55f3237f22d4b8815645b.jpg',
mediaType: 1,
...
let msg = {
rowner: `ᴏɴʟʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
owner: `ᴏɴʟʏ ᴏᴡɴᴇʀ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴏᴡɴᴇʀ ʙᴏᴛ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
mods: `ᴏɴʟʏ ᴍᴏᴅᴇʀᴀᴛᴏʀ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴏᴛ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
premium: `ᴏɴʟʏ ᴘʀᴇᴍɪᴜᴍ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
group: `ɢʀᴏᴜᴘ ᴄʜᴀᴛ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴘᴀᴋᴀɪ ᴅɪᴅᴀʟᴀᴍ ɢʀᴏᴜᴘ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
private: `ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴘᴀᴋᴀɪ ᴅɪᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
admin: `*ᴏɴʟʏ ᴀᴅᴍɪɴ* •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴀᴅᴍɪɴ ɢʀᴏᴜᴘ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
botAdmin: `ᴏɴʟʏ ʙᴏᴛ ᴀᴅᴍɪɴ •${userTag}ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪɢᴜɴᴀᴋᴀɴ ᴋᴇᴛɪᴋᴀ ʙᴏᴛ ᴍᴇɴᴊᴀᴅɪ ᴀᴅᴍɪɴ\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/lembar_jawaban14`,
unreg: `${userTag}ᴀʀᴇ ɴᴏᴛ ʀᴇɢɪsᴛᴇʀᴇᴅ ʏᴇᴛ • ᴋᴇᴛɪᴋ  .daftar ᴜɴᴛᴜᴋ ʙɪsᴀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ ɪɴɪ\n\nᴅᴀꜰᴛᴀʀ ʙɪꜱᴀ ᴅᴇɴɢᴀɴ ᴅᴜᴀ ᴄᴀʀᴀ ᴏᴛᴘ/ꜱɪᴍᴘʟᴇ:\n\nRegistrasi OTP: ex: .daftar bang putra.19\nRegistrasi Simple: ex: @verify\n\nꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: *https://instagram.com/lembar_jawaban14*`, 
restrict: `ʀᴇsᴛʀɪᴄᴛ •${userTag}ʀᴇsᴛʀɪᴄᴛ ʙᴇʟᴜᴍ ᴅɪɴʏᴀʟᴀᴋᴀɴ ᴅɪᴄʜᴀᴛ ɪɴɪ\n\n ꜰᴏʟʟᴏᴡ ɪɴꜱᴛᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/l4c1f2r`,
}[type]
...
body: "",
thumbnailUrl: 'https://telegra.ph/file/55f3237f22d4b8815645b.jpg',
sourceUrl: "https://chat.whatsapp.com/EB3zGN8GFWz5pIXcAt4egq",
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
}
