...
${banned ? `Kamu *Terbanned* Kak 😨\nHubungi: wa.me/${owner[0]}` : `Saya ${wm} Bot Yang Dibuat Oleh Bang Putra Untuk membantu pekerjaan anda sehari-hari, ketik .menu untuk menampilkan menu Di harapkan jangan spam yah kack 🚀`}
`.trim(), m)
    user.pc = new Date * 1
}
